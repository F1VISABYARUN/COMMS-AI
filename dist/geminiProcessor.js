...
exports.processCallAudioWithGemini = processCallAudioWithGemini;
exports.processCallTranscriptWithGemini = processCallTranscriptWithGemini;
 ...
 */
async function processCallAudioWithGemini(audioBuffer, callerId) {
 ...
 */
async function processCallTranscriptWithGemini(transcript, callerId) {
    const apiKey = process.env.GEMINI_API_KEY;
    if (!apiKey) {
        console.error("[ERR] GEMINI_API_KEY is not set.");
        return {
